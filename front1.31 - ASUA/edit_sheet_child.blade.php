	...
	<div class="body_in" style="margin-top: 150px;">
		<div class="bound_sheet">
			<div class="sheet_nav_button">
				<button><a href="{{ route('editsheet') }}">大人用</a></button>
			</div>
		...
		<div class="bound_sheet">
			...
			@include('admin.component.edit_sheet_child_1')
			@include('admin.component.edit_sheet_child_2')
			@include('admin.component.edit_sheet_child_3')
			@include('admin.component.edit_sheet_child_4')
			@include('admin.component.edit_sheet_child_5')
