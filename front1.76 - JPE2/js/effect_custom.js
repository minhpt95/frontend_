...
if (screen.width > 768) {
    ...
    $('.navication-search').on('mouseover', function(){
        $('.header-searchform').addClass('is-active')
    })
    $('.navication-search').on('mouseout', function(){
        $('.header-searchform').removeClass('is-active')
    })

    var sticky = $('#top-page').offset().top;
...
$('.I-slider').find('.slider-next').on('click', function(){
    $('.slider-carousel').trigger('next.owl.carousel');
})
$('.I-slider').find('.slider-prev').on('click', function(){
    $('.slider-carousel').trigger('prev.owl.carousel');
})
$('.I-slider').find('.slider-respon-next').on('click', function(){
    $('.slider-carousel').trigger('next.owl.carousel');
})
$('.I-slider').find('.slider-respon-prev').on('click', function(){
    $('.slider-carousel').trigger('prev.owl.carousel');
})
