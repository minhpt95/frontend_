...
class CalendarPicker {
    ...
    _insertNavigationButtons(){
        ...
        const arrowSvg = '<svg enable-background="new 0 0 200 100" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><path d="M 100 0 L 100 100 L 0 50 z"/></svg>';
        const left = '<i class="fas fa-caret-left"></i>';
        const right = '<i class="fas fa-caret-left"></i>';

        this.previousMonthArrow.innerHTML = left;
        this.nextMonthArrow.innerHTML = right;
    ...
    _insertDaysIntoGrid(){
        ...
        arrayOfDays.forEach(date => {
            ...
            if (dateIsBetweenAllowedRange) {
                ...
                dateElement.classList.add('enable');
            }
